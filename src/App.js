      ...
      <div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="spotcheck-2">
            {companies.map(c => <Company name={c.name} revenue={c.revenue} key={c.name} />)}
          </div>
        </div>
        ...
        <div className="ex-space">
          ...
          {companies.map(c => <Company name={this.upperCase(c.name)} revenue={c.revenue} key={c.name} />)}
          </div>
        </div>
        ...
        <div className="ex-space">
          ...
          {this.state.companies.map(c => <Company name={this.upperCase(c.name)} revenue={c.revenue} key={c.name} />)}
          </div>
        </div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="ex-3">
            {this.state.currentPage === "Home" ? <Home data={this.state.store} />
            : <Landing user={this.state.user} item={this.state.store.find(s => s.hottest)} />}
          </div>
        </div>
        ...
        <div className="ex-space">
          ...
          <Home data={this.state.store} shouldDiscount={this.state.shouldDiscount}/>
          </div>
        </div>
